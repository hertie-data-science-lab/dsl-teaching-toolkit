...
`.github/workflows/console-pages.yml` builds it and deploys it to GitHub Pages at
`https://hertie-data-science-lab.github.io/dsl-teaching-toolkit/`. Its `console/schemas/` are
generated by `python -m dsl_course.schemas`; never edit them by hand.
