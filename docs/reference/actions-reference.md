...
| Action | Effect |
| --- | --- |
| **Bootstrap semester** | Configure a pre-created semester org: `welcome` + `semester-config`, permissions, site, `course_admins`, register + refresh. Safe to re-run on a live semester - your `semester-config` files are never overwritten. |
