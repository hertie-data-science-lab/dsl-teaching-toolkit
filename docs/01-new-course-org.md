...
4. **Add any other admins.** 
   ...
   NB: TAs and co-instructors are **not** granted access here; each semester declares its own in `classroom-config/people.yml` when you [bootstrap that semester](04-new-cohort-org.md).
